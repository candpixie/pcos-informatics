...
- NGL I was also not on time with taking my medication, which was a frustration.
...
### upcoming goals:
- Build a baseline ML classifier for PCOS diagnosis
- Run gene expression differential analysis using public datasets (GEO)
- Summarize key PCOS literature and biomarkers
